...
class TestWallets:
    ...
    def test_method_retrieve(self, client: Paymanai) -> None:
        wallet = client.wallets.retrieve(
            "string",
        )
    ...
    def test_raw_response_retrieve(self, client: Paymanai) -> None:
        response = client.wallets.with_raw_response.retrieve(
            "string",
        )
    ...
    def test_streaming_response_retrieve(self, client: Paymanai) -> None:
        with client.wallets.with_streaming_response.retrieve(
            "string",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Paymanai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.wallets.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncWallets:
    ...
    async def test_method_retrieve(self, async_client: AsyncPaymanai) -> None:
        wallet = await async_client.wallets.retrieve(
            "string",
        )
        assert_matches_type(WalletRetrieveResponse, wallet, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncPaymanai) -> None:
        response = await async_client.wallets.with_raw_response.retrieve(
            "string",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPaymanai) -> None:
        async with async_client.wallets.with_streaming_response.retrieve(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPaymanai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.wallets.with_raw_response.retrieve(
                "",
            )
