...
from paymanai._exceptions import PaymanaiError, APIStatusError, APITimeoutError, APIResponseValidationError
...
class TestPaymanai:
    ...
    def test_omit_retry_count_header(
        self, client: Paymanai, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.version.with_raw_response.get_server_version(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncPaymanai:
    ...
    async def test_retries_taken(
        ...
        response = await client.version.with_raw_response.get_server_version()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPaymanai, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from paymanai._utils import asyncify
        from paymanai._base_client import get_platform 
